...
class KetibRentHistoryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: isActive ? Border.all(color: KetibAppcolors.primary.withOpacity(0.3), width: 1) : null,
      ),
      child: Column(
        children: [
          Padding(
                ...
                Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: isActive ? KetibAppcolors.success.withOpacity(0.1) : Colors.grey[100],
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize: 10,
                          fontWeight: FontWeight.bold,
                          color: isActive ? KetibAppcolors.success : Colors.grey,
                        ),
                      ),
                    ),
                  ],
          ...
          Container(
            ...
            child: Center(
              child: Text(
                ...
                style: TextStyle(
                  color: isActive ? KetibAppcolors.primary : KetibAppcolors.textLight,
  ...
  Widget _buildInfoRow(IconData icon, String text, {bool isBold = false}) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Icon(icon, size: 16, color: KetibAppcolors.textLight),
        ...
        Expanded(
          child: Text(
            ...
            style: TextStyle(
              fontSize: 14,
              color: isBold ? KetibAppcolors.textMain : KetibAppcolors.textLight,
